...
class NotificationTypeCode(str, Enum):
    ...
    EVENT_APPLICATION_REMINDER = "EVENT_APPLICATION_REMINDER"
    EVENT_APPLICATION_STATUS_CHANGED = "EVENT_APPLICATION_STATUS_CHANGED"
    EVENT_CHECK_IN_REMINDER = "EVENT_CHECK_IN_REMINDER"
    EVENT_CHECK_OUT_REMINDER = "EVENT_CHECK_OUT_REMINDER"
    EVENT_FOLLOW_UP = "EVENT_FOLLOW_UP"
    EVENT_SURVEY_REMINDER = "EVENT_SURVEY_REMINDER"
    TICKET_PURCHASE_CONFIRMATION = "TICKET_PURCHASE_CONFIRMATION"
    TICKET_CANCELLATION_CONFIRMATION = "TICKET_CANCELLATION_CONFIRMATION"
    TICKET_REFUND_CONFIRMATION = "TICKET_REFUND_CONFIRMATION"
