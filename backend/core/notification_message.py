NOTIFICATION_MESSAGES = {
    "BOOKMARK_EVENT": {
        "vi": {
            "title": "Bookmark sự kiện",
            "body": '{full_name} đã bookmark sự kiện "{event_name}".',
        },
        "en": {
            "title": "Event Bookmarked",
            "body": '{full_name} has bookmarked the event "{event_name}".',
        },
    },
    "PUBLISH_NEW_EVENT": {
        "vi": {
    ...
    "APPLY_EVENT": {
        ...
        "en": {
            ...
            "body": """{full_name} has purchased the ticket {ticket_name} and intends
    ...
    "UPCOMING_EVENT_REMINDER_7_DAYS_BEFORE": {
        ...
        "en": {
            "title": "⏳ 7 days left until your event!",
