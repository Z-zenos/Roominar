    ...
    <div>
      ...
      <div className='flex 1400px:px-[15%] px-0 w-full'>
        <SidebarProvider open={width > 1200 ? true : false}>
          <AudienceSidebar />
          <SidebarInset className='450px:overflow-auto overflow-hidden'>
            ...
            <div className='flex flex-1 flex-col gap-4 p-4 450px:px-4 px-0'>
              <div className='rounded-xl 450px:bg-muted/50'>{children}</div>
            </div>
          </SidebarInset>
        </SidebarProvider>
      </div>
