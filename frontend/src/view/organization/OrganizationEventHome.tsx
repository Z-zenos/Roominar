...
function OrganizationEventHome({ slug }: OrganizationEventHomeProps) {
  ...
  return isLoading && !event ? (
    ...
    <div className='w-full overflow-hidden'>
      ...
      <div
        className={clsx(
          'dark:bg-dark-sub w-full 450px:py-8 py-8 450px:px-[10%] px-[5%] relative flex-wrap',
          styles.between,
        )}
      >
        {!showCommentsSection && !showFeedbackSection && (
      ...
      <div
        className={clsx(
          'dark:bg-dark-sub w-full 450px:py-4 py-6 450px:px-[10%] px-[5%] relative flex-wrap flex justify-between items-start',
        )}
      >
        {showCommentsSection && (
          <div
