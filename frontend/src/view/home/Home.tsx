...
export default function Home() {
	...
	const { data: applicationClosingSoonEvents, isLoading: isApplicationClosingSoonEventsLoading } =
						...
						<div className='flex justify-between gap-2 items-center bg-info-sub mt-8 rounded-md px-10 py-8'>
							<div>
								...
								<p className='font-light opacity-75'>
									Anyone can create an event page for free by creating a group. Why not publish an
									event for sharing information and interacting with others on Roominar?
								</p>
							</div>
							<Button
