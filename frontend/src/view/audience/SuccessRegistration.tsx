  ...
  return (
    <div className='flex items-center justify-center bg-gray-100'>
      <div className='bg-white p-8 rounded-lg shadow-lg w-full max-w-lg'>
        <h2 className='text-pink-600 text-lg font-bold text-center mb-4'>Currently, You Are Temporarily Registered</h2>
        <p className='text-center mb-4'>
          A one step account verifcation email has been sent to [<span className='font-semibold'>{email}</span>]. Please
          complete the registration using the URL provided in the email.
        </p>
        ...
        <div className='text-center'>
          <Button color='primary' className='my-3 mx-auto w-[160px] font-semibold' radius='none' as={Link} href='/home'>
            Go to Homepage
          </Button>
        </div>
      </div>
