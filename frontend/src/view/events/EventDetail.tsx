...
function EventDetail({ slug }: EventDetailProps) {
  ...
  return false ? (
    ...
    <div className='w-full'>
      <div className={clsx('bg-emerald-50 dark:bg-dark-sub w-full py-14 px-[15%] relative flex-wrap', styles.between)}>
        ...
        <div className={clsx(width > 1200 ? 'w-[25%]' : 'w-full')}>
          ...
          >
            <div>
              <h4 className='text-green-500 font-semibold text-md'>Social Media Share </h4>
              <div className={clsx(styles.between, 'mt-4 [&>*]:cursor-pointer')}>
            ...
            <Link className={clsx(styles.between, 'text-primary gap-2')} href='#' underline='hover'>
      ...
      <div
        className={clsx('dark:bg-dark-sub w-full py-14 px-[15%] relative flex-wrap flex justify-between items-start')}
      >
        <div className={clsx('flex flex-col gap-7', width > 1200 ? 'w-[70%]' : 'w-full mb-8')}>
          {/* === Timeline === */}
          <div>
          ...
          {/* === Detail Schedule === */}
          <div>
            <h3 className='font-semibold text-lg border-b border-b-gray-400'>Detail Schedule</h3>
            <div className='mt-3'>
              <Table aria-label='Example table with dynamic content'>
                <TableHeader columns={columns}>
                  {(column) => (
                    <TableColumn key={column.key} className={clsx(column.key === 'content' && 'w-2/3')}>
                      {column.label}
                    </TableColumn>
                  )}
                </TableHeader>
          ...
          {/* === Speaker === */}
          <div>
            <h3 className='font-semibold text-lg border-b border-b-gray-400'>Speaker</h3>
        ...
        <div className={clsx(width > 1200 ? 'w-[25%]' : 'w-full', 'self-start')}>
          <div>
            <h3 className={clsx(styles.flexStart, 'gap-2 text-lg font-semibold text-primary')}>
              <GoOrganization />
              Organization
            </h3>
            <div className='mt-3 border border-gray-200 shadow-sm'>
              ...
              <div className={clsx(styles.between, 'px-5')}>
                ...
                <div className='text-right mt-3'>
                  ...
                  <p className='mt-2'>
                    <span className='underline font-medium text-sm text-red-500 mr-2'>1231</span>
                    <span className='font-light opacity-80 text-sm'>Follower</span>
                  </p>
                </div>
              </div>
              <div className='my-3 px-5'>
                ...
                <h3 className='font-semibold text-gray-700 text-nm cursor-pointer my-3'>Events</h3>
          ...
          <div>
            <h3 className={clsx(styles.flexStart, 'gap-2 text-lg font-semibold text-orange-500 mt-5')}>
              <GiPartyPopper />
              Related Events
            </h3>
                ...
                <SwiperSlide key={index} className={clsx('dark:rounded-lg dark:p-0')}>
                  <div className='mt-3 border border-gray-200 shadow-sm p-2'>
                    ...
                    <div className='pt-3 px-1'>
                      ...
                      <p className='text-ss font-light opacity-65'>Start at 2012/12/12</p>
                    </div>
                  </div>
