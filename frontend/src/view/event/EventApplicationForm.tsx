...
import { Form, FormCheckBoxList, FormCombobox, FormInput } from '@/src/component/form/Form';
...
export default function EventApplicationForm({ slug }: EventApplicationFormProps) {
	...
	return (
		<Form {...form}>
			<form
				...
				className={clsx('grid grid-cols-7 w-full items-start gap-10 mx-auto px-[15%] py-20')}
			>
					...
					{event && (
						<div className='rounded-md p-5 shadow-[rgba(0,_0,_0,_0.02)_0px_1px_3px_0px,_rgba(27,_31,_35,_0.15)_0px_0px_0px_1px]'>
							...
							<div className={clsx(styles.between)}>
								<Chip
									content={event.appliedNumber + ' / ' + event.applicationNumber}
				...
				<div className='col-span-5'>
					<div className='w-full shadow-[rgba(0,_0,_0,_0.16)_0px_1px_4px] border border-gray-200 px-10 py-6 rounded-md'>
						<h2 className='text-lg font-semibold text-primary'>Enter your detail information ✍</h2>
					...
					<div className='w-full shadow-[rgba(0,_0,_0,_0.16)_0px_1px_4px] border border-gray-200 px-10 py-6 rounded-md mt-6'>
						<h2 className='text-md font-semibold text-secondary'>Answer some questions</h2>
						<p className='font-light opacity-80 text-sm'>
							Your answers will be an extremely useful and valuable source of information to help us
							survey, analyze and improve the quality of future events.
						</p>
						<div className='mt-4'>
							<h3 className='text-nm font-semibold text-slate-800'>1. Oh this is question.</h3>
							<FormCheckBoxList
								name='answerResults'
								control={form.control}
								title='Test'
								data={[{ value: '1', label: 'This is test answer' }]}
							/>
						</div>
					</div>
