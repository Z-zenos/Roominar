		...
		<div className='w-full'>
			...
			>
					...
					<div>
						...
						<div className='mt-3'>
							<p
								className={clsx(
									'font-light',
									showMore ? 'h-auto' : 'h-[400px] overflow-hidden gradient-mask-b-0',
								)}
							>
								{event?.description}
							</p>
				...
				<div className={clsx(width > 1200 ? 'w-[25%]' : 'w-full', 'self-start')}>
						...
						<div className='mt-3 border border-gray-200 shadow-sm'>
							...
							<div className='my-3 px-5'>
								...
								<p className='opacity-70 text-ss line-clamp-3'>
									...
									illum veritatis quis dicta. Laboriosam a minus aliquam amet, iure velit sunt nemo
									voluptatem labore dolores quo incidunt fugiat in!
								</p>
					...
					<div>
						<h3
							className={clsx(styles.flexStart, 'gap-2 text-lg font-semibold text-orange-500 mt-5')}
						>
							<GiPartyPopper />
							Related Events
						</h3>
