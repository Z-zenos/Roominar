export const styles = {
  label: 'text-sm font-Poppins text-black font-light dark:text-white',
  input:
  ...
  section:
    '1200px:w-[80%] 1000px:w-[90%] 800px:w-[95%] m-auto 450px:py-16 py-4 450px:px-0 w-full',
  between: 'flex justify-between items-center',
  flexStart: 'flex justify-start items-center gap-1',
  shadow: 'shadow-[rgba(0,_0,_0,_0.16)_0px_8px_16px_0px]',
  verticalLine: 'bg-gray-300 w-[1px] h-8',
};
