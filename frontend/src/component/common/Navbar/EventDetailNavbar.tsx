...
interface EventDetailMenuBarProps extends React.HTMLAttributes<HTMLDivElement> {
  items: MenuItem[];
  activeItem?: string;
...
export const EventDetailMenuBar = React.forwardRef<
  HTMLDivElement,
  EventDetailMenuBarProps
...
EventDetailMenuBar.displayName = 'EventDetailMenuBar';
