...
import type {SecurityAuthentication} from '../auth/auth';
    ...
    */
    export class SurveysApiRequestFactory extends BaseAPIRequestFactory {
        ...
        */
        public async createSurvey(createSurveyRequest?: CreateSurveyRequest, _options?: Configuration): Promise<RequestContext> {
            ...
            requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8")
                ...
                ObjectSerializer.serialize(createSurveyRequest, "CreateSurveyRequest", ""),
                contentType
                );
        ...
        */
        public async listingSurveyOptions(_options?: Configuration): Promise<RequestContext> {
            const _config = _options || this.configuration;

            // Path Params
            const localVarPath = '/api/v1/surveys/options';
        ...
        export class SurveysApiResponseProcessor {
            ...
            */
            public async createSurveyWithHttpInfo(response: ResponseContext): Promise<HttpInfo<number >> {
            ...
            * to the expected objects
            *
            * @params response Response returned by the server for a request to listingSurveyOptions
            * @throws ApiException if the response code was not in [200, 299]
            */
            public async listingSurveyOptionsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Array<ListingSurveyOptionsItem> >> {
            const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
                if (isCodeInRange("200", response.httpStatusCode)) {
                        const body: Array<ListingSurveyOptionsItem> = ObjectSerializer.deserialize(
                        ObjectSerializer.parse(await response.body.text(), contentType),
                        "Array<ListingSurveyOptionsItem>", ""
                        ) as Array<ListingSurveyOptionsItem>;
                        return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
                }
                if (isCodeInRange("400", response.httpStatusCode)) {
                        const body: ErrorResponse400 = ObjectSerializer.deserialize(
