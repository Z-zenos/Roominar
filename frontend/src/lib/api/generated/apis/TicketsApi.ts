...
import type {SecurityAuthentication} from '../auth/auth';
    ...
    */
    export class TicketsApiRequestFactory extends BaseAPIRequestFactory {
        ...
        */
        public async cancelTickets(cancelTicketsRequest?: CancelTicketsRequest, _options?: Configuration): Promise<RequestContext> {
            const _config = _options || this.configuration;


            // Path Params
            const localVarPath = '/api/v1/tickets/cancel';
            ...
            requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8")
                ...
                ObjectSerializer.serialize(cancelTicketsRequest, "CancelTicketsRequest", ""),
                contentType
                );
        ...
        */
        public async createTicket(createTicketRequest?: CreateTicketRequest, _options?: Configuration): Promise<RequestContext> {
            const _config = _options || this.configuration;
            ...
            requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8")
                ...
                requestContext.setHeaderParam("Content-Type", contentType);
                const serializedBody = ObjectSerializer.stringify(
                ObjectSerializer.serialize(createTicketRequest, "CreateTicketRequest", ""),
                contentType
                );
                requestContext.setBody(serializedBody);
        ...
        */
        public async deleteTicket(ticketId: number, _options?: Configuration): Promise<RequestContext> {
            const _config = _options || this.configuration;
                    ...
                    throw new RequiredError("TicketsApi", "deleteTicket", "ticketId");
                    }


            // Path Params
            const localVarPath = '/api/v1/tickets/{ticket_id}'
        ...
        /**
            ...
            * @param ticketId 
        */
        public async getDraftTicket(ticketId: number, _options?: Configuration): Promise<RequestContext> {
            const _config = _options || this.configuration;

                    // verify required parameter 'ticketId' is not null or undefined
                    if (ticketId === null || ticketId === undefined) {
                    throw new RequiredError("TicketsApi", "getDraftTicket", "ticketId");
                    }


            // Path Params
            const localVarPath = '/api/v1/tickets/{ticket_id}/draft'
                .replace('{' + 'ticket_id' + '}', encodeURIComponent(String(ticketId)));
        ...
        */
        public async updateTicket(ticketId: number, updateTicketRequest?: UpdateTicketRequest, _options?: Configuration): Promise<RequestContext> {
            const _config = _options || this.configuration;

                    // verify required parameter 'ticketId' is not null or undefined
                    if (ticketId === null || ticketId === undefined) {
                    throw new RequiredError("TicketsApi", "updateTicket", "ticketId");
                    }
            ...
            requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8")
                ...
                requestContext.setHeaderParam("Content-Type", contentType);
                const serializedBody = ObjectSerializer.stringify(
                ObjectSerializer.serialize(updateTicketRequest, "UpdateTicketRequest", ""),
                contentType
                );
                requestContext.setBody(serializedBody);
        ...
        export class TicketsApiResponseProcessor {
            ...
            *
            * @params response Response returned by the server for a request to cancelTickets
            * @throws ApiException if the response code was not in [200, 299]
            */
            public async cancelTicketsWithHttpInfo(response: ResponseContext): Promise<HttpInfo<number >> {
            ...
            * @throws ApiException if the response code was not in [200, 299]
            */
            public async createTicketWithHttpInfo(response: ResponseContext): Promise<HttpInfo<number >> {
            const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
                if (isCodeInRange("200", response.httpStatusCode)) {
                        const body: number = ObjectSerializer.deserialize(
                        ObjectSerializer.parse(await response.body.text(), contentType),
            ...
            * @throws ApiException if the response code was not in [200, 299]
            */
            public async deleteTicketWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
            const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
            ...
            * to the expected objects
            *
            * @params response Response returned by the server for a request to getDraftTicket
            * @throws ApiException if the response code was not in [200, 299]
            */
            public async getDraftTicketWithHttpInfo(response: ResponseContext): Promise<HttpInfo<Ticket >> {
            const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
                if (isCodeInRange("200", response.httpStatusCode)) {
            ...
            * @throws ApiException if the response code was not in [200, 299]
            */
            public async updateTicketWithHttpInfo(response: ResponseContext): Promise<HttpInfo<TicketItem >> {
            const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
                if (isCodeInRange("200", response.httpStatusCode)) {
                        const body: TicketItem = ObjectSerializer.deserialize(
                        ObjectSerializer.parse(await response.body.text(), contentType),
                        "TicketItem", ""
                        ) as TicketItem;
                        return new HttpInfo(response.httpStatusCode, response.headers, response.body, body);
