...
import type {SecurityAuthentication} from '../auth/auth';
    ...
    * no description
    */
    export class FeedbacksApiRequestFactory extends BaseAPIRequestFactory {

        /**
            * Delete Feedback
            * @param feedbackId
        */
        public async deleteFeedback(feedbackId: number, _options?: Configuration): Promise<RequestContext> {
            const _config = _options || this.configuration;

                    // verify required parameter 'feedbackId' is not null or undefined
                    if (feedbackId === null || feedbackId === undefined) {
                    throw new RequiredError("FeedbacksApi", "deleteFeedback", "feedbackId");
                    }


            // Path Params
            const localVarPath = '/api/v1/feedbacks/{feedback_id}'
        ...
        */
        public async updateFeedback(feedbackId: number, updateFeedbackRequest?: UpdateFeedbackRequest, _options?: Configuration): Promise<RequestContext> {
            const _config = _options || this.configuration;

                    // verify required parameter 'feedbackId' is not null or undefined
                    if (feedbackId === null || feedbackId === undefined) {
                    throw new RequiredError("FeedbacksApi", "updateFeedback", "feedbackId");
                    }
            ...
            requestContext.setHeaderParam("Accept", "application/json, */*;q=0.8")
                ...
                ObjectSerializer.serialize(updateFeedbackRequest, "UpdateFeedbackRequest", ""),
                contentType
                );
        ...
        export class FeedbacksApiResponseProcessor {
            ...
            */
            public async deleteFeedbackWithHttpInfo(response: ResponseContext): Promise<HttpInfo<void >> {
            ...
            * @throws ApiException if the response code was not in [200, 299]
            */
            public async updateFeedbackWithHttpInfo(response: ResponseContext): Promise<HttpInfo<number >> {
            const contentType = ObjectSerializer.normalizeMediaType(response.headers["content-type"]);
